<section 
    id="origin-sanctuary" 
    class="relative z-10 min-h-[300dvh] bg-linear-to-b from-background to-background-1 overflow-x-clip pt-40 
   ...
   <div class="sticky top-0 left-0 h-screen overflow-hidden">
      <div id="origin-wrapper" class="grid grid-cols-1 gap-5 min-h-screen max-h-screen py-20">
         <div class="absolute inset-0 self-center place-self-center z-1">
            <h1 id="title-origin-sanctuary" class="font-headings text-5xl text-center xl:text-8xl md:mix-blend-exclusion text-accent">IT BEGAN WITH A PAUSE</h1>
         </div>
         <div class="flex flex-col flex-1 justify-start px-20">
