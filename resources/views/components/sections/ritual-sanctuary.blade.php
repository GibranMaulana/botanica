...
<div class="relative min-h-[500dvh]" id="ritual-sanctuary">
   <section class="sticky top-0 left-0 h-screen grid grid-cols-1 justify-center xl:justify-betweeen xl:grid-cols-3 px-10 xl:px-20 pt-20 pb-10 content-center gap-8 overflow-hidden 
      ...
      <div class="flex flex-col h-fit xl:h-full lg:justify-end text-xs sm:text-sm md:text-base">
         ...
         <p class="text-justify description2 sm:max-w-sm text-pretty hidden">
      ...
      <div class="flex-col h-fit xl:h-full items-center justify-center img-container2 overflow-hidden my-1 hidden">
      ...
      <div class="flex flex-col h-fit xl:h-full justify-end xl:justify-between items-start sm:items-end">
         ...
         <h2 class="italic text-xl sm:text-2xl md:text-3xl lg:text-4xl font-headings text-pretty text-start sm:text-end text-primary headings2 uppercase hidden">RITUAL 02 • {{ $products[1]->variants->first()->sku }} </h2>
         ...
         <div class="flex flex-col items-start sm:items-end text-gr ">
            <div class="button2-container order-2 hidden">
            ...
            <h1 class="italic text-4xl sm:text-5xl md:text-6xl lg:text-7xl 2xl:text-8xl order-1 font-headings text-pretty text-start sm:text-end uppercase headings2 hidden">{{ $products[1]->name }}</h1>
         </div>
      </div>
   </section>
</div>