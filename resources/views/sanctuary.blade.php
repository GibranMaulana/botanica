<x-layouts.app namespace="sanctuary">
   <section class="relative min-h-screen">
      ...
      <div class="absolute bottom-8 inset-x-8 flex flex-row justify-between items-center">
         <a href="" class="font-headings text-white text-4xl">[ Begin The Journey ]</a>
         <h3 class="text-white tracking-wide border-b-2">Est. 2024 • Organic Skincare & Tea</h3>
         <h2 class="text-white tracking-wide max-w-2xs text-pretty text-justify">Heavy glass. Cold stone. Raw clay. A collection of grounding elements designed to pull you out of your head and back into your body</h2>
      </dev>
