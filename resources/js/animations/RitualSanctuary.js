...
export class RitualSanctuary {
    ...
    init() {
        this.ctx = gsap.context(() => {
            ...
            tl.to(p1.img, { autoAlpha: 1, scale: 1, duration: 2 })
                .to(p1.img, { yPercent: -20, duration: 6 }, "<")
                .to(p1.desc, { autoAlpha: 1, y: 0, duration: 2 }, "<")
                .to(p1.desc, { yPercent: -40, duration: 6 }, "<")
                .to(p1.sub, { autoAlpha: 1, x: 0, duration: 2 }, "<")
                .to(p1.sub, { yPercent: -30, duration: 6 }, "<")
                .to(p1.btn, { y: 0, duration: 2 }, "<")
                // .to(p1.btn, { yPercent: -20, duration: 6 }, "<")
                .from(
                    split1.chars,
                    {
                        opacity: 0,
                ...
                .to(p1.mainHeading, { yPercent: -30, duration: 6 }, "<")
                .to({}, { duration: 6 }, "<");
            ...
            tl.addLabel("enter_p2")
                ...
                .to(p2.img, { yPercent: -10, duration: 6 }, "enter_p2")
                .to(p2.desc, { autoAlpha: 1, y: 0, duration: 2 }, "enter_p2")
                .to(p2.desc, { yPercent: -30, duration: 6 }, "enter_p2")
                .to(p2.sub, { autoAlpha: 1, x: 0, duration: 2 }, "enter_p2")
                .to(p2.sub, { yPercent: -30, duration: 6 }, "enter_p2")
                .to(p2.btn, { y: 0, duration: 2 }, "enter_p2")
                // .to(p2.btn, { yPercent: -30, duration: 6 }, "enter_p2")
                .from(
                    split2.chars,
                    {
                        opacity: 0,
                ...
                .to(p2.mainHeading, { yPercent: -30, duration: 6 }, "enter_p2");

            tl.to({}, { duration: 6 }, "enter_p2");
